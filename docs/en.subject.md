...
- [C++ - Module 02](#c---module-02)
  - [Ad-hoc polymorphism, operator overloading and the Orthodox Canonical class form](#ad-hoc-polymorphism-operator-overloading-and-the-orthodox-canonical-class-form)
...
This will be the starting point of your C++ journey. Many languages are recommended for learning OOP, but we decided to choose C++ since it's derived from your old friend C. Because this is a complex language, and in order to keep things simple, your code will comply with the **C++98 standard**.
...
Please read [this 3 pages article](https://www.wikiwand.com/en/Fixed-point_arithmetic) to discover that you don't. Go on, read it.
...
As C++ lacks fixed-point numbers, you're going to add them. [This article from Berkeley](https://www.eecs.berkeley.edu/~fateman/papers/Rright.pdf) is a good start.
...
Should output something like (constructor/destructor messages removed for readability):
...
> **Note:** If you ever do a division by 0, it is acceptable that the program crashes
...
> **Note:** You can pass this module without completing exercise 03. :)

Now that you have a functional Fixed class, it would be nice to use it. Implement a function that indicates whether a point is inside a triangle or not. Very useful, isn't it?
